...
export default function NewCampaignPage() {
  return (
    <div>
      ...
      />
      <form action={createCampaignAction} className={cardClass + " flex max-w-2xl flex-col gap-4"}>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-1.5">
            ...
            <input id="badge" name="badge" placeholder="Örn. Sınırlı Süre" className={inputClass} />
          </div>
          <div className="flex flex-col gap-1.5">
        ...
        <SubmitButton>Kampanyayı Kaydet</SubmitButton>
      </form>
    </div>
  );
}
